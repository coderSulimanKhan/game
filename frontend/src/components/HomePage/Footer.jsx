...
const Footer = () => {
  return (
    <>
      {/* Mobile */}
      <div className="border w-full absolute gap-2 bottom-25 h-[9vh] flex flex-col md:hidden items-center justify-between px-4">
        <div className="flex items-center justify-between border w-full">
          <div className="gb hoverEffect borderShadow rounded-lg px-4 py-1 flex flex-col items-center justify-center gap-1">
            <img src="/pages/HomePage/troops.svg" alt="Troops" className="h-8 myShadow" />
            <p className="text-lg font-bold text-orange-100 ts">Troops</p>
          </div>
